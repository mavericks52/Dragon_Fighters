...
if(obj_batman.vsp == 0){
	image_angle = 90; 
	Is_Jump = 0;
	sprite_set_offset(spr_batarang, 0, 0);
...
if(Is_Jump  == 0)
{
	...
	if(dir == -1)
	{
		...
		/// @DnDArgument : "y" "obj_batman.y-125"
		direction = point_direction(x, y, obj_batman.x+1000, obj_batman.y-125);
	}
	...
	else
	{
		...
		/// @DnDParent : 1EF1F687
		/// @DnDArgument : "x" "obj_batman.x+1000"
		/// @DnDArgument : "y" "obj_batman.y-30"
		direction = point_direction(x, y, obj_batman.x+1000, obj_batman.y-30);
	}
}