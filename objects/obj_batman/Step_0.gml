...
if(batman_hp == 0){
	...
	if(hsp == 0 && vsp == 0) len = 0;else len = sqrt(power(vsp,2)+power(hsp,2));
// used later
...
/*knockback
if(knockback_force_applied >= 0){
	hspd_force = lengthdir_x(knockback_force_applied,knockback_dir - 180);
	vspd_force = lengthdir_y(knockback_force_applied,knockback_dir - 180);

	knockback_force_applied *=.8;
}

//hsp = lengthdir_x(len,dir) + hspd_force;
vsp = lengthdir_y(len, dir) - vspd_force ;
*/
