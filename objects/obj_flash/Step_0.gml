...
if (keyboard_check_pressed(ord("Z"))==1 && alarm[2]<=1){
	...
	alarm[2] = (fire_rate/0.1);
	instance_create_layer(x,y+30,"particles",obj_lightningBolt);
	}
}
...
if(flash_hp == 0)
{
	...
	/// @DnDHash : 38A23971
	/// @DnDParent : 4A986D83
	/// @DnDArgument : "var" "obj_flash.death_animation"
	/// @DnDArgument : "value" "1"
	if(obj_flash.death_animation == 1)
	{
		/// @DnDAction : YoYo Games.Particles.Part_Particles_Create
		/// @DnDVersion : 1
		/// @DnDHash : 3A7317BD
	...
	/// @DnDParent : 4A986D83
	/// @DnDArgument : "var" "obj_flash.death_animation"
	if(obj_flash.death_animation == 0)
	{
